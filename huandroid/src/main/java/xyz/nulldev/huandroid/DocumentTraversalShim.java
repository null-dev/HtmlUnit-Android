...
// Class renamed and included to workaround a bug where the compiler would claim that
//   org.w3c.dom.traversal.DocumentTraversal does not exist.
/**
 ...
 * @since DOM Level 2
 */
public interface DocumentTraversalShim {
    /**
