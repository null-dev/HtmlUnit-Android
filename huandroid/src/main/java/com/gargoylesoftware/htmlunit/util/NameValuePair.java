...
public class NameValuePair implements Serializable {
     ...
     */
    public static cz.msebera.android.httpclient.NameValuePair[] toHttpClient(final NameValuePair[] pairs) {
        final cz.msebera.android.httpclient.NameValuePair[] pairs2 =
            new cz.msebera.android.httpclient.NameValuePair[pairs.length];
     ...
     * @return the converted name/value pairs
     */
    public static cz.msebera.android.httpclient.NameValuePair[] toHttpClient(final List<NameValuePair> pairs) {
        final cz.msebera.android.httpclient.NameValuePair[] pairs2 = new cz.msebera.android.httpclient.NameValuePair[pairs.size()];
