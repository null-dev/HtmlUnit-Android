...
public class Cookie implements Serializable {
     ...
     */
    public cz.msebera.android.httpclient.cookie.Cookie toHttpClient() {
     ...
     */
    public static List<cz.msebera.android.httpclient.cookie.Cookie> toHttpClient(final Collection<Cookie> cookies) {
        final ArrayList<cz.msebera.android.httpclient.cookie.Cookie> array = new ArrayList<>(cookies.size());
     ...
     */
    public static List<Cookie> fromHttpClient(final List<cz.msebera.android.httpclient.cookie.Cookie> cookies) {
        final List<Cookie> list = new ArrayList<>(cookies.size());
        for (cz.msebera.android.httpclient.cookie.Cookie c : cookies) {
